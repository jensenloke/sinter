...
usage: sinter [command] [args]
  ...
  show <id-prefix> [--tail n] [--json]   render all or the latest transcript entries
...
const COMMAND_HELP: Record<string, string> = {
  ...
  show: "usage: sinter show <id-prefix> [--tail n] [--json] [--tool-chars n] [--no-sub]\n\n--tail renders only the latest n entries from each session. It cannot be combined with --json because the result would not be a complete SIF document.",
